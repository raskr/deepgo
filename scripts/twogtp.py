...
# use like
# python twogtp.py --white 'sbt --error "run --mode gtp -s 1 -p 1"' --black 'gnugo --mode gtp' --verbose
...
match = GTP_match(white, black, size, komi, handicap, handicap_type, streak_length, endgame_filelist)
if endgame_filelist != []:
